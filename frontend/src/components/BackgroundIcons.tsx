...
/* =====================================================
   ...
   - Cada ícone possui: tamanho, posição, cor e rotação
   - Criados para efeito de background dinâmico/animado
   - Mantemos consistência visual com gradientes e contraste suave
===================================================== */
const icons = [
...
/* =====================================================
   Componente BackgroundIcons
   - Renderiza ícones em posição absoluta
   - Aplica efeitos de flutuação e hover
    ...
    <div className="absolute inset-0 pointer-events-none">
      {icons.map((item, idx) => (
        <div
          ...
          style={{
            top: item.top,                 // Posição vertical
            left: item.left,               // Posição horizontal
            fontSize: item.size,           // Tamanho do ícone
            transform: `rotate(${item.rotation})`, // Rotação para estilo dinâmico
          }}
        >
          {item.icon}
        </div>
